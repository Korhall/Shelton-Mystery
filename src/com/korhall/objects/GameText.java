...
// пункт 1
            ...
            "278\n" +
                    "\n" +
                    "Джон не успевает вовремя заметить Водяного и наталкивается на него. Короткий удар трезубцем — и ваш спутник мертв. Теперь вернитесь на 253 и сделайте выбор. С одной стороны, за убитого товарища надо мстить. С другой — если Водяной был часовым, то его нетрудно понять.\n"
            ,
            //пункт 279
            "279\n" +
                    "\n" +
                    "Подплыв ближе, вы обнаруживаете, что дупло плотно закрыто деревянной крышкой, сделанной, по-видимому, из того же дерева. Похоже на тайник, но как его открыть? Если у вас есть Рыба-пила, то проблема решена (458). Если нет, то вскрыть крышку мечом невозможно: она слишком толстая, чтобы ее прорубить, и слишком плотно подогнана, чтобы можно было попытаться просунуть меч в щель. Делать нечего — придется уплывать из леса ни с чем — 396.\n"
            ,
            //пункт 280
            "280\n" +
                    "\n" +
                    "Старик немало удивлен подобной просьбой и воспринимает ее как странную причуду, за которую еще и заплатят. Рассказ его сбивчив и неясен, но из него можно понять следующее. Слева от вас, в той стороне, куда вы плывете, Ущелье смерти. Ни человек, ни рыба никогда не возвращались оттуда, и никто не знает, какие силы там правят. Если же поплывете прямо, можете встретить затонувший корабль, но кто и как его потопил, старик ничего сказать не может. Когда же спрашиваете про Неведомое, то лодочник просто не понимает, о чем вы говорите, и, пожав плечами, уплывает — 365.\n"
            ,
            //пункт 281
            "281\n" +
                    "\n" +
                    "Помочь погибшим собратьям — священный долг каждого моряка, и вы соглашаетесь выполнить их просьбу. Но это действительно требует немало сил. Киньте два кубика и вычтите из своей ВЫНОСЛИВОСТИ сумму чисел, которые на них выпали. Но не расстраивайтесь — мертвецы вознаградят вас за доброту. Когда работа закончена и кости погребены, вы слышите загробный голос: \"Спасибо, друг. Возьми эти жемчужины, и пусть они помогут тебе\". На могильном холме и в самом деле внезапно появляются два прекрасных изумруда: можете взять их с собой. Они волшебные и не займут никакого места в ваших карманах. Когда же захотите ими воспользоваться, вычтите 29 из номера параграфа, на котором будете находиться, и узнаете, как они могут вам помочь. Теперь же прибавьте себе 2 УДАЧИ и отправляйтесь дальше: к развалинам, которые видны неподалеку (402), или в открытое море (103).\n"
            ,
            //пункт 282
            "282\n" +
                    "\n" +
            ...
            "394\n" +
                    "\n" +
                    "Осторожно вплываете в люк и обнаруживаете вашего спутника лежащим на дне без признаков жизни. Он мертв, а на его шее виднеются четыре красных пятнышка — следы от укуса какой-то рыбы. Поторопитесь покинуть корабль и поплывете дальше один (8) или все же осмотрите отсеки: каюту капитана (585), каюту штурмана (364) или трюм (411)?\n"
            ,
            //пункт 395
            "395\n" +
                    "\n" +
            ...
            "396\n" +
                    "\n" +
                    "Наконец-то удалось выйти из леса, который уже начал давить своими сводами. Но куда направиться теперь? Прямо перед вами на морском дне видна небольшая уютная впадина, поросшая темно-зелеными водорослями (86), а справа вдалеке — невысокая скала (575).\n"
            ,
            //пункт 397
            "397\n" +
                    "\n" +
                    "Гигантская устрица слишком аппетитна, а вы голодны и к тому же знаете, что у нее должно быть очень нежное и вкусное мясо. Но открыть створки не так-то просто (говорят, для того чтобы открыть обычную устрицу, и то требуется навык). Когда же наконец удается это сделать (потеряйте 1 ВЫНОСЛИВОСТЬ), есть уже хочется просто неимоверно, но именно в этот момент у вас появляется конкурент. Вы попали в ловушку, расставленную огромным Морским пауком. Он приготовил что-то вроде мышеловки, положив туда устрицу вместо сыра, а вы клюнули на наживку. Теперь сражайтесь.\n"
                    + "МОРСКОЙ ПАУК\n" +
                    "\n" +
                    "Мастерство 9 Выносливость 9\n" +
                    "\n" +
            ...
            "398\n" +
                    "\n" +
                    "Однако уплыть без приключений не удается. Вас поджидает Рыба-единорог, гораздо более агрессивная, чем ее земной собрат. Если хотите, можете попытаться бежать (119), иначе же\n" +
                    "\n" +
                    "РЫБА-ЕДИНОРОГ\n" +
                    "\n" +
                    "\n" +
            ...
            "400\n" +
                    "\n" +
                    "Справедливо решив, что руководить командой в одиночку все-таки слишком опасно, вы спрашиваете хозяина таверны, как найти Джона. Он посылает своего сына проводить вас, и через четверть часа петляния по узким портовым улочкам вы подходите к небольшому кабачку, на пороге которого ведут разговор два матроса. Мальчик показывает на одного из них и говорит, что это и есть тот, кого вы ищете. В это время Джон прощается с товарищем и направляется в вашу сторону. Заговорив с ним и объяснив, кто помог его найти, предлагаете ему отправиться в море на поиски приключений. Джон с большим сомнением относится к такому предложению. Судя по всему, он считает, что это верная смерть, и хотел бы по крайней мере знать, ради чего придется рисковать жизнью. Расскажете ему о цели путешествия (529) или постараетесь прельстить деньгами, сохранив все в тайне (246)?\n"
            ,
            //пункт 401
            "401\n" +
                    "\n" +
                    "Вы углубляетесь в лес и через некоторое время выходите к небольшому лесному озерку, на противоположном берегу которого пьют воду два оленя. Услышав шаги, один из них поднимает голову, но не убегает, а спокойно возвращается к прерванному занятию. Похоже, олени либо совсем ручные (и тогда где-то поблизости должны быть люди), либо они, наоборот, видят человека впервые в жизни и поэтому не боятся. Обогнете озеро и подойдете к оленям (175) или покинете остров, потеряв на нем 25 минут (407)?\n"
            ,
            //пункт 402
            "402\n" +
                    "\n" +
                    "Вы подплываете поближе: перед вами развалины замка, невесть как оказавшегося на дне моря. Камням не одна сотня лет, и более или менее сохранилась только главная башня, хорошо заметная издалека. Она немного покосилась, во кажется почти такой же прочной, какой была много веков назад. Ее ворота давно уже никому не препятствуют входить внутрь: одна их половинка лежит на дне рядом со входом, другой вообще не видно поблизости. Мирную картину нарушает только стайка маленьких серебристых рыбок, появившаяся из главного входа в башню. Завидев вас, рыбы испуганно кидаются прочь. Башня кажется давным-давно заброшенной и необитаемой. Но кто знает, что может скрываться за ее метровыми стенами или в подземельях. Если хотите, можете вплыть внутрь и исследовать остатки некогда грозной и могучей цитадели (239). Или направитесь прочь, решив, что посещение замка принесет больше опасностей, чем выгод (15)?\n"
            ,
            //пункт 403
            "403\n" +
                    "\n" +
            ...
            "574\n" +
                    "\n" +
                    "Ваше самообладание сыграло решающую роль. Вместо того, чтобы потерять голову (и, естественно, угодить в ловушку), вы не забыли придерживаться стены, чтобы не сбиться с пути, а потому благополучно выбрались на свет. Теперь — в бой.\n" +
                    "\n" +
                    "КРЫЛАТЫЙ ЛЕВ\n" +
                    "\n" +
                    "\n" +
                    ...
                    "\n" +
                    "\n" +
                    "Если удалось выйти из схватки победителем, можете либо покинуть остров, проведя на нем 40 минут (324), либо, соблюдая все меры предосторожности, вернуться в логово Льва и осмотреть его (61).\n"
            ,
            //пункт 575
            "575\n" +
                    "\n" +
                    "Подплыв к скале, обнаруживаете узкий вход у ее основания. Хотите посмотреть, что там находится (475), или не станете рисковать (135)?\n"
            ,
            //пункт 576
            "576\n" +
                    "\n" +
                    "Вы тянетесь мечом, но листья-щупальца обвивают руку и стараются вырвать оружие. ПРОВЕРЬТЕ СВОЮ УДАЧУ. Если удачливы, то 377, если нет, — 112.\n"
            ,
            //пункт 577
            "577\n" +
                    "\n" +
                    ...
                    "\n" +
                    "\n" +
                    "Мастерство 10 Выносливость 8 которые сражаются с вами.\n" +
                    "\n" +
                    "Теперь, если вы убили своих противников, а сражение первой пары продолжается, есть возможность помочь Водяному. Порядок боя определяйте сами. Можете, чтобы не запутаться, кидать кубики сначала за одну группу, потом за другую, можете попеременно. Если все враги мертвы, то 198.\n"
            ,
            //пункт 578
            "578\n" +
                    "\n" +
                    "Вы решаете взять камешек с собой. (Если он когда-нибудь понадобится, прибавьте 376 к номеру параграфа, на котором будете в этот момент находиться.) После этого благодарите Морскую звезду, извиняетесь за забывчивость и плывете дальше — 32.\n"
            ,
            //пункт 579
            "579\n" +
                    "\n" +
            ...
            "580\n" +
                    "\n" +
                    "В конце концов, Тунцу надоедает эта игра. Он резко прибавляет скорость, а вы достаточно устали (потеряйте 1 ВЫНОСЛИВОСТЬ), чтобы сделать то же самое. Если у вас есть трезубец, то 219. Если же нет, то остается только пожалеть о потерянном времени и задуматься: не выполнял ли Тунец чью-то волю, попросту заманивая или уводя от определенного места. Однако найти ответ на эту задачку невозможно, и вы плывете дальше —189.\n"
            ,
            //пункт 581
            "581\n" +
                    "\n" +
            ...
            "582\n" +
                    ...
                    "\n" +
                    "\n" +
                    "Мастерство 10 Выносливость 16 минус потери от ран\n" +
                    "\n" +
            ...
            "584\n" +
                    "\n" +
                    "Раковина прекрасна, и вы осторожно кладете ее в карман. Когда она понадобится, прибавьте 271 к номеру параграфа, на котором будете находиться. Теперь, если вы еще не брали золотой пояс (338) или браслет (74), можете это сделать, иначе придется плыть дальше (508).\n"
            ,
            //пункт 585
            "\n" +
                    "585\n" +
                    "\n" +
                    "Лишь только вы открываете дверь капитанской каюты, как на вас бросается какая-то рыба с разинутой пастью, усеянной маленькими остренькими зубками. Что вы сделаете? Попытаетесь быстро захлопнуть дверь (14) или примете вызов (170)?\n"
            ,
            //пункт 586
            "586\n" +
                    "\n" +
                    "Подплыв поближе, видите, что на дне построен маленький фонтанчик. Только вместо воды у него струятся вверх пузырьки воздуха. Хотите приблизиться (144) или предпочтете миновать его стороной (336)?\n"
            ,
            //пункт 587
            "587\n" +
                    "\n" +
                    "Солнечная рыба немедленно приходит на помощь. Она превращается в сильный поток света, который, кажется, послан для вашей защиты самим небом. Свет делится на две части, потом каждая из них еще на две. Четыре острых луча вонзаются в глаза воинам, и те падают замертво. А сияние медленно гаснет и исчезает — 217.\n"
            ,
            //пункт 588
            "588\n" +
                    "\n" +
                    "С трудом находите в себе силы, чтобы подняться, но в следующую же секунду снова летите на пол. Качка слишком сильна, чтобы можно было удержаться на ногах. Не остается ничего другого, как только ждать, когда она прекратится. Минут через десять и крики, и качка стихают, но вместо этого корабль наполняет невнятный гул. Это шумит вода, которая врывается через пробоины и заполняет все отсеки. Бежать уже поздно: такой поток ничем не остановить, а преодолеть его невозможно. Для вас, как и для корвета, путешествие закончено…\n"
            ,
            //пункт 589
            "589\n" +
                    "\n" +
                    ...
                    "\n" +
                    "\n" +
                    "Мастерство 10 Выносливость 12 минус потери от ран\n" +
                    "\n" +
                    "\n" +
                    "ВТОРОЙ ПИРАТ\n" +
                    "\n" +
            ...
            "591\n" +
                    "\n" +
                    "Если вы считаете, что настало время воспользоваться амулетом, Дьявол в помощь, но учтите, что это можно сделать только один раз, после чего он исчезнет. Если хотите изменить свое решение, вернитесь на 490 и сражайтесь.\n"
            ,
            //пункт 592
            "592\n" +
                    "\n" +
                    "Теперь можете плыть дальше. Справа от вас видна огромная одинокая скала, вершина которой уходит к самой поверхности. Если у вас есть диадема с рубином, то вы знаете, какой параграф надо посмотреть. Если есть раковина, то 225. Если нет ни того, ни другого, ваш путь лежит налево, где виднеется что-то очень похожее на мельницу, — 302.\n"
            ,
            //пункт 593
            "593\n" +
                    "\n" +
            ...
            "605\n" +
                    "\n" +
                    "Аккуратно надеваете обруч. Он удобно сидит на голове и абсолютно не мешает. Когда представится возможность использовать загадочную диадему, вычтите 100 из номера параграфа, на котором будете в этот момент. А теперь пора двигаться дальше —126.\n"
            ,
            //пункт 606
            "606\n" +
                    "\n" +
                    "Как только вы достаете амулет, обе рыбы в одно мгновение исчезают. Но исчезает и сам амулет, ведь его можно использовать только один раз, — 592.\n"
            ,
            //пункт 607
            "607\n" +
                    "\n" +
                    "Не закрывая страницу с параграфом 224, продолжайте сражение. Когда последний враг будет убит — 198. Если к тому времени посланник Принца останется в живых, он исчезнет. И пусть вас не смущает, что вы будете сражаться вдвоем против одного, ведь вначале пиратов было больше.\n"
            ,
            //пункт 608
            "608\n" +
                    "\n" +
                    "Меч не причинит серьезного вреда внутренностям огромного Кита, а другой возможности выбраться уже не будет. Остается только одно утешение: умрете одной из самых оригинальных из существующих для человека смертей — вас переварит Кит…\n"
            ,
            //пункт 609
            "609\n" +
                    "\n" +
                    "У вас остается единственный шанс: поговорить с Великаном. Но, к сожалению, использовать этот шанс не удается. Довольный тем, что заклятие успешно подействовало, Великан со страшным криком бросается вперед и одним ударом огромного меча сносит голову дерзкому сопернику. Тайна Неведомого так и осталась нераскрытой…\n"
            ,
            //пункт 610
            "610\n" +
                    "\n" +
            ...
            "612\n" +
                    "\n" +
                    "Вдали виднеется большой подводный луг. Поплывете дальше в этом направлении (520) или в противоположную сторону(243)?\n"
            ,
            //пункт 613
            "613\n" +
                    "\n" +
                    "Вы нападаете на Русалку, но она только смеется. Каждый раз, когда кажется, что меч вот-вот поразит ее, она едва заметно виляет Хвостом, исчезает и вновь появляется уже за вашей спиной. Несколько минут она забавляется игрой, а потом пропадает совсем — 437.\n"
            ,
            //пункт 614
            "614\n" +
                    "\n" +
            ...
            "629\n" +
                    ...
                    "Вы же снова погружаетесь в море и плывете вокруг острова. Так и есть, с другой его стороны пришвартован небольшой корабль, на котором приплыли те самые пираты, с которыми вы дрались. Парусов на нем немного, поэтому можно рискнуть выйти в море и постараться дотянуть до оживленных морских путей. А там, без сомнения, можно встретить какое-нибудь судно. Тайна Неведомого раскрыта. Еще несколько дней уйдет на то, чтобы найти сокровища и перенести их на корабль, и можете отправляться в путь. А если когда-нибудь вам наскучит быть богатым бездельником, то всегда можно вернуться в старый добрый Грейкеп, который не поскупится на приключения. Тогда можно будет стать героем совсем другой истории…\n"
